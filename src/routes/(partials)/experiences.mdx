...
<Experience
  title='React Application Refactoring & Modernization'
  company='BUFDIR'
...
<Experience
  title='CLI Tool Development for Image Transfer & Metadata Processing'
  company='Hegnar Media AS'
...
<Experience
  title='React Application Refactoring & State Management Implementation'
  company='Norkart AS'
...
<Experience
  ...
  company='Intergate / Hansen Services'
...
<Experience
  title='Cloud Server Administration & Web Hosting'
  company='Intergate / Hansen Services'
  period='Jan 2015 - Ongoing'
  skillsList={[
    'Cloudflare',
...
<Experience
  title='Subscription & Billing System Development'
  company='Funcom Oslo AS'
