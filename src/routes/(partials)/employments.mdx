...
<Experience
  company='TechPros (Technology Professionals AS)'
  title='Consultant / subcontractor'
...
<Experience
  company='Snapper Net Solutions AS'
  title='Senior Developer'
