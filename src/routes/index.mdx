...
<Card title='Welcome' fullWidth={true} centerContent={true}>
...
I specialise in interoperability and integration of web-technologies. Micro-sites, sites and apps within sites, connecting things together.
</ExpandableDetails>
