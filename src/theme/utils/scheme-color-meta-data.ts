import type { ColorMetadataByName, ColorNumber, CssColor, GlobalColors } from './types';
...
const colorMetadataByNumber = Object.fromEntries(
  Object.values(colorMetadata).map(metadata => [metadata.number, metadata])
);
